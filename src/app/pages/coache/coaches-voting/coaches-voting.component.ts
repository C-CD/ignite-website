...
@Component({
  selector: 'app-coaches-voting',
  templateUrl: './coaches-voting.component.html',
  styleUrls: [
    './coaches-voting.component.css',
    '../../competition/male/players/players.component.css'
  ]
})
export class CoachesVotingComponent implements OnInit {
